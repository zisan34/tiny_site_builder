...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Member Details</li>
        </ol>
    </section>
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" title="Post Title" placeholder="Member Name" required="required" value="{{$member->name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="designation">Member Designation :<small style="color:red">*</small></label>
                                                <input type="text" name="designation" class="form-control" title="Post Title" placeholder="Member Designation" required="required" value="{{$member->designation}}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" id="details_div">
                                            ...
                                            @endphp
                                            <textarea name="info" id="summernote" cols="30" rows="30"> {{ str_replace($rp_string, "", $member->info) }}</textarea>
                                        </div>
                                    </div>
                                                    ...
                                                    @foreach($categories as $category)
                                                        ...
                                                        @foreach($category->member_subcategories as $subcategory)
                                                            <option value="{{$category->id}}|{{$subcategory->id}}" class="item"
                                                                @if($member->subcategory_id == $subcategory->id)
                                                                selected
                                                                @endif >
                                                                {{$subcategory->title}}
                                                            </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="draft_order" name="order" title="Post Order" required="required"  value="{{$member->order}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
