...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Member Categories List</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{route('member_categories.update',['id'=>$category->id])}}" method="post">
                            @csrf
                            {{method_field('PUT')}}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <a class="btn btn-block btn-primary pull-right"  style="margin-top: 24px;"  href="{{route('member_categories.index')}}">Go back</a>
                                            </div>
                                            <div class="col-md-4">
